...
export const redisPublishDurationMicroseconds = new client.Histogram({
    name: 'redis_publish_duration_seconds',
    help: 'Duration of Redis Publish operations in seconds',
    labelNames: ['event'],
    buckets: [0.01, 0.05, 0.1, 0.3, 0.5, 1]
});
register.registerMetric(redisPublishDurationMicroseconds);
